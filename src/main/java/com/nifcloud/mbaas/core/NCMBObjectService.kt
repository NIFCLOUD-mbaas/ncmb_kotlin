...
internal open class NCMBObjectService() : NCMBService(), NCMBServiceInterface<NCMBObject> {
    ...
    fun saveObject(
        ...
        var response = sendRequest(url, method, null, params, contentType, query)
        when (response) {
    ...
    fun saveObjectInBackground(
        ...
        sendRequestAsync(url, method, null, params, contentType, query, saveCallback, saveHandler)
    }
    ...
    fun updateObjectInBackground(
        ...
        sendRequestAsync(url, method, null, params, contentType, query, updateCallback, updateHandler)
    }
