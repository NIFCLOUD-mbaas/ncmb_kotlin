...
class NCMBInstallationService: NCMBService() {
     ...
     */
//    internal abstract inner class InstallationServiceCallback : ServiceCallback {
//        /**
//         * constructors
//         */
//        constructor(service: NCMBInstallationService?, callback: DoneCallback?) : super(
//            service,
//            callback
//        ) {
//        }
//
//        constructor(service: NCMBInstallationService?, callback: ExecuteServiceCallback?) : super(
//            service,
//            callback
//        ) {
//        }
//
//        constructor(service: NCMBInstallationService?, callback: FetchCallback?) : super(
//            service,
//            callback
//        ) {
//        }
...
//    )
    ...
    fun createRequestParams(
        ...
        val url: String = if (objectId != null) {
            //PUT,GET(fetch)
            NCMB.getApiBaseUrl() + this.mServicePath + className + "/" + objectId
        } else {
            //POST,GET(search)
            NCMB.getApiBaseUrl() + this.mServicePath + className
        }
...
//        reqParams.type = method
        return RequestParams(url = url, method = method, params = params, query = query, contentType = contentType)
    }
